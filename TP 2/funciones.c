...
/**
 * Obtiene el indice ocupado libre del array que fue buscado.
 * @param lista el array se pasa como parametro.
...
/**
 * Pide DNI para ingresar como parametro.
 */
int pedirDni(void)
{
    int dni;
...
/**
 * Pide nombre para ingresar como parametro.
 */
...
/**
 * Pide edad para ingresar como parametro.
 */
int pedirEdad(void)
{
    int edad;
